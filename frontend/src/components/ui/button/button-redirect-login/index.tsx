...
export function ButtonRedirectLogin({
  ...
  return (
    <div className="fixed bottom-4 left-4 rounded-full bg-primary p-3 cursor-pointer shadow-sm shadow-primary transition duration-300 hover:bg-primary-dark hover:scale-105">
